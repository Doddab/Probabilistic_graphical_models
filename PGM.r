...
library(gtools)
library(entropy)
filepath = "/home/karthik/Documents/CSE674/Project/Reqset/Cursive/Grade3_cursive"
setwd(filepath)
...
save(entrop,file="grade3cursive_entropy.Rda")
save(meanmat,file="grade3cursive_mean.Rda")
save(H,file="grade3cursive_logloss1.Rda")
save(HH,file="grade3cursive_logloss2.Rda")